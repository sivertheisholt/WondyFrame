# General infomation
WondyFrame is a discord bot used for finding information about drop locations of items and world state in Warframe. It's made with the user in mind so the usability is the main priority for this bot.
