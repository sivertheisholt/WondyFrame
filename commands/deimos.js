...
function createEmbed(worldState, worldStateTimestamp) {
	...
	let cambionEmbed = new Discord.MessageEmbed()
		...
		.setThumbnail(
			"https://raw.githubusercontent.com/wfcd/warframe-items/development/data/img/heart-of-deimos.png"
		)
		.addField(
			"Current state",
			helperMethods.data.makeCapitalFirstLettersFromString(worldState.active),
			false
		)
